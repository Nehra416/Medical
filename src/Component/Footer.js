...
import fotter from './social_media_applications_19-telegram-64.webp';
import fotterIn from './Linkedin.webp';
import fotterFb from './Facebook.webp';
import fotterInsta from './Instagram.webp';

const Footer = () => {
    return (
        <div className='bg-[#1F2B6C] px-[5%] mt-[300px]'>
